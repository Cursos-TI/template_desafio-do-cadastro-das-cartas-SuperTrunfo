...
/* variavel para comparação
 //Calcular super da carta 1
   ...
   printf ("\n --- QUE COMECE A GUERRAAA!!!!HAAAAA ---\n");

    if (populacao1 > populacao2){
 printf ( "Carta 1 venceu o Ataque!!!\n");}
  else{ 
  printf( "Carta 2 venceu o Ataque De população!!\n");}

  printf ("\n --- Batalha 02 !!! ---\n");

  if (area1 > area2){
 printf ( "Carta 1 venceu o Ataque Aereo!!!");}
  else{ 
  printf( "Carta 2 venceu o Ataque De Aereo!!\n");}
